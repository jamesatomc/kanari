...
pub static G_LOCAL_CONFIG: Lazy<GenesisConfig> = Lazy::new(|| GenesisConfig {
    bitcoin_network: rooch_types::bitcoin::network::Network::Regtest.to_num(),
...
pub static G_TEST_CONFIG: Lazy<GenesisConfig> = Lazy::new(|| {
    GenesisConfig {
        bitcoin_network: rooch_types::bitcoin::network::Network::Testnet.to_num(),
...
pub static G_MAIN_CONFIG: Lazy<GenesisConfig> = Lazy::new(|| GenesisConfig {
    bitcoin_network: rooch_types::bitcoin::network::Network::Bitcoin.to_num(),
